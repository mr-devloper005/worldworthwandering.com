        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[1.02fr_0.98fr] lg:items-start">
          ...
          <div className={`rounded-[1.8rem] p-7 ${tone.panel}`}>
            ...
            <form className="mt-6 grid gap-4">
              ...
              <input className="h-12 rounded-xl border border-current/10 bg-transparent px-4 text-sm" placeholder="Company or publication (optional)" />
              <select className="h-12 rounded-xl border border-current/10 bg-transparent px-4 text-sm">
                <option>Choose a topic</option>
                <option>Editorial / content</option>
                <option>Partnerships</option>
                <option>Listings and business support</option>
                <option>Technical issue</option>
              </select>
              <input className="h-12 rounded-xl border border-current/10 bg-transparent px-4 text-sm" placeholder="Subject" />
              <textarea className="min-h-[180px] rounded-2xl border border-current/10 bg-transparent px-4 py-3 text-sm" placeholder="Share links, goals, and timeline so we can respond with clear next steps." />
